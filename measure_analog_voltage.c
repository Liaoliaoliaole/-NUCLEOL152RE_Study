/*
 Create such software, which can measure analog voltage by using two channels 
 (pins A0 and A1 in Nucleo board). 
 First, measure 12-bit ADC-values without input signal and take results to spreadsheet. 
 Use realterm as output screen.9600 br
*/
